  ...
  return (
    ...
    <div className="a4">
     <div className="background-image">
      {/* <img src={imageEnabled} alt=" image-Enabled"  className="enable-image" /> */}
      <div className="main-header">
        ...
        <div className="personal-details">
          ...
          <div className="second-name">
            <p class="name">Chiranjeevi.<b> Kamalesh P</b></p>
          </div>
    ...
    <div className="residential-address">
          <p class="address"> Address:{residentialAddress.address}  {residentialAddress.landmark} {residentialAddress.hometown}, {residentialAddress.city}, {residentialAddress.stateName} {residentialAddress.pincode}  {residentialAddress.nationality}</p>

    </div>
    <div className="contact-details">
          <p class="address">Mobile : {contactDetails.contactNumber}  &nbsp;&nbsp; &nbsp;&nbsp;  WhatsApp Number : {contactDetails.whatsappNumber}</p>
        </div>
        <div class="email-address"> 
        <p class="address">Email: {contactDetails.emailId}</p>
        </div>
    </div>
    </div>
  );
